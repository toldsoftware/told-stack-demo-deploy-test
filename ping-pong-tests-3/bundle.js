...
var convert = __webpack_require__(280).convert;
var bodyStream = __webpack_require__(301);
var PassThrough = __webpack_require__(5).PassThrough;
var FetchError = __webpack_require__(273);
...
const node_fetch_1 = __webpack_require__(279);
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let a = 0; a < attempts; a++) {
            for (let i = 0; i < pongUrls.length; i++) {
                ...
                context.log('PING', Object.assign({}, x));
                try {
                    let { name, url } = x;
                    // if (a === 0) {
                    ...
                    const r = yield node_fetch_1.default(url + `${0 | 100000 * Math.random()}`, { timeout: 5000 });
                    const responseTime = Date.now();
                    context.log('Received PONG', Object.assign({}, x, { ok: r.ok, status: r.status }));
                    let d = {
                        time: pingTime,
                        timeIso: '',
                    };
...
var Body = __webpack_require__(257);
var Response = __webpack_require__(302);
var Headers = __webpack_require__(259);
...
var iconvLite = __webpack_require__(281);
// Load Iconv from an external file to be able to disable Iconv for webpack
// Add /\/iconv-loader$/ to webpack.IgnorePlugin to ignore it
var Iconv = __webpack_require__(299);
...
var bomHandling = __webpack_require__(282),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(283); // Lazy load all encoding definitions.
...
module.exports = {
    ...
    'eucjp': {
        type: '_dbcs',
        table: function() { return __webpack_require__(293) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
    },
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(258).concat(__webpack_require__(271)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return __webpack_require__(258).concat(__webpack_require__(271)) },
        gb18030: function() { return __webpack_require__(294) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'cp949': {
        type: '_dbcs',
        table: function() { return __webpack_require__(295) },
    },
    ...
    'cp950': {
        type: '_dbcs',
        table: function() { return __webpack_require__(272) },
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(272).concat(__webpack_require__(296)) },
...
Object.defineProperty(exports, "__esModule", { value: true });
const config_1 = __webpack_require__(305);
...
Object.defineProperty(exports, "__esModule", { value: true });
class Config {
    constructor(http_routeRoot = 'api/ping-pong', default_storageConnectionString_AppSettingName = 'AZURE_STORAGE_CONNECTION_STRING') {
...
Object.defineProperty(exports, "__esModule", { value: true });
const ping_pong_1 = __webpack_require__(278);
const ping_pong_2 = __webpack_require__(304);
const run = function (...args) {
    ping_pong_1.runFunction.apply(null, [ping_pong_2.config, ...args]);
};
global.__run = run;
